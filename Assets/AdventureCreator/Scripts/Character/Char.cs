...
namespace AC
{
	...
	public class Char : MonoBehaviour, ITranslatable
	{
		 ...
		 */
		public Rect GetAnimatedPortraitRect ()
		{
			if (GetPortrait () != null)
			{
				if (isLipSyncing)
				{
					return GetPortrait ().GetAnimatedRect (GetLipSyncFrame ());
				}
				else if (isTalking)
				{
					return GetPortrait ().GetAnimatedRect ();
				}
				else
				{
					return GetPortrait ().GetAnimatedRect (0);
				}
			}
